        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="mb-6">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-blue-200">from 50K+ reviews</span>
              </div>
            ...
            <div className="flex items-center space-x-6 mb-8">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-green-400 font-semibold">2M+ Happy Customers</span>
              </div>
              <div className="flex items-center space-x-2">
                <Award className="h-5 w-5 text-yellow-400" />
                <span className="text-yellow-400 font-semibold">Best E-commerce 2024</span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link
                  to="/categories"
                  className="bg-gradient-to-r from-yellow-400 to-orange-400 text-gray-900 px-8 py-4 rounded-xl font-bold hover:from-yellow-300 hover:to-orange-300 transition-all duration-300 flex items-center justify-center space-x-2 shadow-2xl"
                >
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link
                  to="/categories"
                  className="border-2 border-white/50 backdrop-blur-sm text-white px-8 py-4 rounded-xl font-bold hover:bg-white/20 transition-all duration-300 flex items-center justify-center"
                >
                  Browse Categories
                </Link>
              </motion.div>
          ...
          >
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-8 -left-8 bg-white text-gray-900 p-6 rounded-2xl shadow-2xl">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Protected Shopping</p>
                  </div>
                </div>
              </div>
              
              <div className="absolute -top-8 -right-8 bg-gradient-to-r from-blue-500 to-purple-500 text-white p-6 rounded-2xl shadow-2xl">
      ...
      <div className="bg-white/95 backdrop-blur-sm text-gray-900 py-8 border-t border-white/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div 
              className="flex items-center space-x-4 p-4 rounded-xl hover:bg-blue-50 transition-colors"
            ...
            <motion.div 
              className="flex items-center space-x-4 p-4 rounded-xl hover:bg-green-50 transition-colors"
              whileHover={{ scale: 1.05 }}
            >
            ...
            <motion.div 
              className="flex items-center space-x-4 p-4 rounded-xl hover:bg-purple-50 transition-colors"
              whileHover={{ scale: 1.05 }}
            >
              ...
              <div>
                ...
                <p className="text-gray-600">Same day in select cities</p>
              </div>
            </motion.div>
          </div>
        </div>
